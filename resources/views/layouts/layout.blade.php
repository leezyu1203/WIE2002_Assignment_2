...
<head>
    ...
    <title>@yield('title') - Azure Wave Inn</title>
...
<body>
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('images/AzureWaveInn-nav.png') }}" alt="azure-wave-inn" height="38px">
            </a>
    ...
    <footer>
        <div class="row w-100">
            <div class="col-6">Copyright 2024 @ Azure Wave Inn. All rights reserved.</div>
            <div class="col-6 d-flex justify-content-end">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                    class="bi bi-facebooks me-4" viewBox="0 0 16 16">
                    <path
